...
\begin{itemize}
    \item 68,489 plays (95.3\%) had stable optimal decisions
    \item Of these, coaches made the optimal decision on 53,774 plays (78.5\%)
    \item The remaining 14,715 plays (21.5\%) were \textbf{inexcusable mistakes}
\end{itemize}
