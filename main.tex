...
\midrule
2010 CHI @ DET & 4th \& 7, opp 38, tied, 4:24 Q4 & PUNT & FG & 17.9\% \\
2015 SF @ LA & 4th \& 4, opp 37, tied, 1:39 Q4 & PUNT & FG & 16.8\% \\
2016 NYG @ DAL & 4th \& 1, opp 37, up 1, 1:12 Q4 & PUNT & GO & 13.7\% \\
2018 LAC @ SF & 4th \& 1, opp 37, up 2, 3:57 Q4 & PUNT & GO & 13.1\% \\
2010 CLE @ CAR & 4th \& 2, opp 36, up 1, 1:07 Q4 & PUNT & GO & 13.0\% \\
\bottomrule
\end{tabular}
\end{table}

\begin{remark}[Interpreting the Worst Decisions]
The costliest decisions share a common pattern: punting from opponent territory in close late-game situations. The top two cases involve teams punting when a field goal attempt would have been clearly preferable---at the opponent's 37--38 yard line (55-yard kicks), coaches chose to give up possession entirely rather than attempt a makeable field goal. The remaining cases involve punting on short yardage (4th \& 1 or 4th \& 2) from opponent territory when the model strongly favored going for it. The 13--18\% margins reflect genuinely suboptimal decisions where the coach selected the dominated action.

These results contrast sharply with popular narratives. The 2021 Bills @ Titans game, where Buffalo went for it on 4th \& 1 from the Tennessee 3-yard line with 22 seconds remaining while trailing by 3, is \textit{not} among the worst decisions. Our neural network win probability model shows going for it was correct: E[WP $|$ GO] = 54.6\% versus E[WP $|$ FG] = 44.8\%, reflecting the $\sim$67\% historical touchdown rate from this position. Josh Allen was stopped for no gain, but this was execution failure, not decision error.
\end{remark}
