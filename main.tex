...
\midrule
2024 NE @ MIA & 4th \& 15 at opp 17, down 5, 1:00 Q4 & GO & FG & 9.7\% \\
2021 BUF @ NE & 4th \& 14 at opp 18, down 4, 2:00 Q4 & GO & FG & 9.4\% \\
2021 CLE @ PIT & 4th \& 12 at opp 26, down 5, 1:58 Q4 & GO & FG & 8.2\% \\
2019 LA @ PIT & 4th \& 10 at opp 30, down 5, 1:30 Q4 & GO & FG & 7.8\% \\
2022 SEA @ ATL & 4th \& 18 at opp 38, down 4, 1:30 Q4 & GO & FG & 7.3\% \\
\bottomrule
\end{tabular}
\end{table}

The most costly decision in our sample occurred in Week 13, 2021: \textbf{Buffalo at New England} in the infamous Monday Night Football ``wind game.'' With the Bills trailing 14--10 and 2:00 remaining, Josh Allen faced 4th \& 14 from the Patriots' 18-yard line. Rather than attempt a 35-yard field goal (roughly 85\% make probability in normal conditions), Buffalo went for it and failed. The model estimates this decision cost 9.4 percentage points of win probability.

A common pattern emerges: teams trailing late attempt long-shot conversions instead of taking guaranteed (or near-guaranteed) points. The ``hero ball'' mentality---preferring a dramatic touchdown attempt to a methodical field goal---systematically costs win probability.
...
The average team loses approximately \textbf{0.34 expected wins per season} from suboptimal fourth-down decisions. The spread between best (Cincinnati, 0.26) and worst (Chicago, 0.47) is 0.21 wins---equivalent to roughly one additional win every five seasons from decision-making improvement alone.

While these magnitudes seem small, they accumulate meaningfully over time. A team that consistently makes optimal fourth-down calls gains roughly one expected win per three seasons compared to an average team. Given that playoff berths are often decided by a single game, this represents genuine competitive advantage.
