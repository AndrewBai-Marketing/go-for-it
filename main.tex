...
Unlike fourth down where we found no improvement in decision quality, coaches \textit{are} improving at PAT/2pt decisions---but slowly. The trend of $+1.05$ pp/year is modest but positive. Coaches started at $\sim$43\% optimal in 2016 (when training data was scarce) and have stabilized around $\sim$55\% optimal as more post-rule data accumulated. This likely reflects the simpler decision structure: with only two options and clear probability estimates, the ``right'' answer is easier to internalize over time.
