...
\node[down2] (pat_make) at (-5, -2.5) {DOWN 2\\[3pt]\textbf{WP = 41\%}};
\node[down3] (pat_miss) at (-2, -2.5) {DOWN 3\\[3pt]\textbf{WP = 35\%}};

% Terminal nodes - 2pt branch
\node[down1] (twopt_make) at (2, -2.5) {DOWN 1\\[3pt]\textbf{WP = 48\%}};
\node[down3] (twopt_miss) at (5, -2.5) {DOWN 3\\[3pt]\textbf{WP = 35\%}};
...
E[WP|PAT] = 0.94 $\times$ 0.41 + 0.06 $\times$ 0.35\\
\hspace{2.2cm}= \textbf{40.6\%}
};

\node[calcbox, fill=green!5, draw=green!50!black] (calc_2pt) at (3.5, -5.5) {
E[WP|2pt] = 0.48 $\times$ 0.48 + 0.52 $\times$ 0.35\\
\hspace{2.2cm}= \textbf{41.2\%}
};
...
DIFFERENCE: +0.6\% $\to$ GO FOR 2 IS BETTER
};
