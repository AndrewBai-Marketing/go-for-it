...
\begin{itemize}[nosep]
  \item Ex ante optimal rate: \textbf{80.8\%} (flat trend, $-0.09$ pp/year, $p = 0.18$)
  \item \textbf{96.6\%} of optimal decisions were knowable in real-time
  \item Teams lose \textbf{0.27 expected wins/season} from fourth down errors
  \item League-wide WP loss \textbf{increasing}: 7.9 wins (2006) $\to$ 11.9 wins (2024)
\end{itemize}
...
\midrule
\textit{Overall} & 71,786 & 14.8\% & \textbf{80.8\%} & 80.0\% & \textbf{96.6\%} \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Key finding:} 96.6\% of optimal decisions were knowable in real-time. Hindsight explains almost nothing.

\subsection*{Trend Analysis}

\textbf{No improvement over time:}
\begin{itemize}[nosep]
  \item Linear trend: $-0.09$ pp/year ($p = 0.18$)---not statistically significant
  \item Early period (2006--2012): 81.0\% optimal
  \item Late period (2019--2024): 79.5\% optimal
\end{itemize}
...
\midrule
DAL (best) & 0.24 & 0.29 & 0.30 & 0.20 & 0.31 & \textbf{0.23} \\
NO & 0.17 & 0.25 & 0.15 & 0.31 & 0.27 & 0.22 \\
SF & 0.28 & 0.25 & 0.28 & 0.13 & 0.37 & 0.22 \\
\midrule
\textit{League Avg} & 0.27 & 0.30 & 0.34 & 0.34 & 0.37 & 0.27 \\
\bottomrule
\end{tabular}
\end{center}
\end{contributionbox}
...
\begin{itemize}[nosep]
  \item 2006--2015 average: 0.24 wins/team/season
...
96.6\% of optimal decisions knowable in real-time & \new \\
...
\begin{itemize}[nosep]
  ...
  \item The gap is \textit{growing}, not shrinking (7.9 wins 2006 $\to$ 11.9 wins 2024)
\end{itemize}
