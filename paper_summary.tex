...
\begin{itemize}[nosep]
  \item Ex ante optimal rate: \textbf{80.8\%} (flat trend, $-0.05$ pp/year, $p = 0.54$)
  \item \textbf{96.5\%} of optimal decisions were knowable in real-time
...
\midrule
\textit{Overall} & 71,786 & 14.8\% & \textbf{80.8\%} & 80.0\% & \textbf{96.5\%} \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Key finding:} 96.5\% of optimal decisions were knowable in real-time. Hindsight explains almost nothing.
