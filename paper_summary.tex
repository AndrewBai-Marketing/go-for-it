...
\begin{itemize}[nosep]
  \item $p_{\text{convert}}$: Hierarchical logistic regression on yards to go \known
  \item $p_{\text{punt}}$: Normal model for net punt yards (mean $\approx$ 40 yds) \known
  \item $p_{\text{make}}$: Logistic regression on kick distance \known
  \item $\text{WP}$: \textbf{Neural network} (3-layer MLP: 128-64-32, ReLU, 20\% dropout) trained on 710K plays \new
\end{itemize}

\textbf{End-of-game filtering:} Following Baldwin (2021, nfl4th), we exclude plays with $<$60 seconds remaining where WP models become unreliable due to clock management and kneel-out scenarios. This removes 1.4\% of plays.
...
\midrule
2006 & 3,829 & 12.1\% & 81.3\% & 77.8\% & 93.5\% \\
2010 & 3,840 & 12.5\% & 81.9\% & 78.5\% & 94.4\% \\
2015 & 3,824 & 12.4\% & 78.8\% & 80.3\% & 96.6\% \\
2020 & 3,402 & 19.3\% & 79.8\% & 79.1\% & 97.3\% \\
2024 & 3,827 & 20.0\% & 78.3\% & 78.4\% & 97.8\% \\
\midrule
\textit{Overall} & 71,786 & 15.3\% & \textbf{80.1\%} & 79.2\% & \textbf{96.4\%} \\
\bottomrule
\end{tabular}
\end{center}
...
2016 & NYG @ DAL & 4th \& 1, opp 37, $+1$, 1:12 Q4 & Punt & Go & 13.7\% \\
2018 & LAC @ SF & 4th \& 1, opp 37, $+2$, 3:57 Q4 & Punt & Go & 13.1\% \\
2010 & CLE @ CAR & 4th \& 2, opp 36, $+1$, 1:07 Q4 & Punt & Go & 13.0\% \\
\bottomrule
\end{tabular}
\end{center}
\normalsize
...
\begin{itemize}[nosep]
  \item Punting from opponent territory when FG was clearly better (top 2)
  \item Punting on short yardage (4th \& 1--2) in opponent territory when GO was optimal
  \item Close games in Q4 where possessing the ball has high value
\end{itemize}

\textbf{Note on BUF @ TEN (2021):} Earlier logistic WP models flagged Buffalo's 4th \& 1 from the TEN 3 with 22 seconds left (down 3) as the ``worst decision ever.'' Our neural network WP model---which correctly captures goal-line dynamics---shows GO was actually \textit{correct}: E[WP$|$GO] = 54.6\% vs E[WP$|$FG] = 44.8\%. Josh Allen's failed run was execution failure, not decision error.
...
96.5\% of optimal decisions knowable in real-time & \new \\
