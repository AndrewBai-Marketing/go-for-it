...
\caption{Two-point conversion learning curve (2016--2024). Defensibly optimal rate improved from 83\% to 99\%, with a trend of +2.32 pp/year ($p < 0.001$). Coaches have demonstrably learned the new decision environment created by the 2015 rule change.}
\end{figure}

\textbf{Key findings (post-2015):}
\begin{itemize}[nosep]
    \item Defensibly optimal rate: 83\% (2016) $\to$ 99\% (2024)
    \item Trend: $+2.32$ pp/year ($p < 0.001$)
    \item Strict optimal rate: 54\% average, $+1.05$ pp/year trend
