...
\caption{Two-point conversion analysis around the 2015 rule change (expanding window, full hierarchical model). Left: Pre-2015 shows high variance due to limited training data in early years. Post-2015 stabilizes around 55\% optimal with a modest +1.2 pp/year trend. Right: PAT success rate dropped from $\sim$99\% to $\sim$94\%.}
\end{figure}

\textbf{Key findings (post-2015, proper expanding window):}
\begin{itemize}[nosep]
    \item Average optimal rate: $\sim$55\% (range: 43--58\%)
    \item Trend: $+1.2$ pp/year (modest improvement)
    \item Coaches are learning \textit{slowly}, unlike fourth downs where trend is flat
\end{itemize}

The pre-2015 results show high variance because early years (2006-2007) have insufficient training data for reliable hierarchical estimates. The post-2015 pattern is more stable: coaches started around 43-47\% optimal in the first years after the rule change and have gradually improved to $\sim$55\%.
